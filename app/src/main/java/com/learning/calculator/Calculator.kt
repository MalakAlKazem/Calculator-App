...
import com.learning.calculator.ui.theme.LightGray
import com.learning.calculator.ui.theme.Orange
        ...
        Column (
            ...
            Row(
                ...
                CalculatorButton(
                    symbol = "AC",
                    modifier = Modifier
                        .background(LightGray)  // Set background color
                        .aspectRatio(2f)        // Set aspect ratio (2:1)
                        .weight(2f)  ,
                    onClick={
                ...
                CalculatorButton(
                    symbol = "/",
                    modifier = Modifier
                        .background(Orange)  // Set background color
                        .aspectRatio(2f)        // Set aspect ratio (2:1)
                        .weight(2f)  ,
                    onClick={
            ...
            Row(
                ...
                CalculatorButton(
                    ...
                    modifier = Modifier
                        ...
                        .aspectRatio(1f)        // Set aspect ratio (2:1)
                        .weight(1f)  ,
                    onClick={
